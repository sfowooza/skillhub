...
class SkillDetails extends StatefulWidget {
  ...
  @override
  State<SkillDetails> createState() => _MyWidgetSkillsDetailsState();
}

class _MyWidgetSkillsDetailsState extends State<SkillDetails> {
         ...
         children: [Container(
          ...
          width: double.infinity,
           child: ColorFiltered(
                ...
                child: Image.network("https://coffee.avodahsystems.com/v1/storage/buckets/664baa5800325ff306fb/files/${widget.data.data["image"]}/view?project=6648f3ff003ca1aedbec",
                        fit: BoxFit.cover
                        ),
              )),
               Positioned(
       ...
       Padding(
         ...
         child: Column(
              ...
              children: [
                Row(children:[
                  Expanded(
                    child: Text( widget.data.data["firstName"],
                                  style: TextStyle(
                  ...
                  isRSVPedEvent
                      ...
                      : SizedBox(
                          ...
                          child: MaterialButton(
                            color: BaseColors().baseTextColor,
                            onPressed: () {
                              database.rsvpEvent(widget.data.data["participants"],
                                      widget.data.$id)
                                  .then((value) {
                                if (value) {
                                  setState(() {
